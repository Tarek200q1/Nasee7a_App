...
import { validationMiddleware , authenticationMiddleware  ,  hostUpload } from "../../../Middlewares/index.js";
...
authRouter.post('/upload-profile-host' , authenticationMiddleware , hostUpload({}).single('profile') , userServices.UploadProfileService)
